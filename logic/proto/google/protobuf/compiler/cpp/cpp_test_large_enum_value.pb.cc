...
static void InitDefaultsTestLargeEnumValue() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_TestLargeEnumValue =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsTestLargeEnumValue}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_TestLargeEnumValue.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/protobuf/compiler/cpp/cpp_test_large_enum_value.proto", schemas, file_default_instances, TableStruct::offsets,
...
TestLargeEnumValue::TestLargeEnumValue()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto::scc_info_TestLargeEnumValue.base);
  SharedCtor();
...
const TestLargeEnumValue& TestLargeEnumValue::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto::scc_info_TestLargeEnumValue.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::protobuf_unittest::TestLargeEnumValue* Arena::CreateMaybeMessage< ::protobuf_unittest::TestLargeEnumValue >(Arena* arena) {
