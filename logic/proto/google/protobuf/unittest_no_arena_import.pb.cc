...
static void InitDefaultsImportNoArenaNestedMessage() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ImportNoArenaNestedMessage =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsImportNoArenaNestedMessage}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ImportNoArenaNestedMessage.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/protobuf/unittest_no_arena_import.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ImportNoArenaNestedMessage& ImportNoArenaNestedMessage::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fprotobuf_2funittest_5fno_5farena_5fimport_2eproto::scc_info_ImportNoArenaNestedMessage.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::proto2_arena_unittest::ImportNoArenaNestedMessage* Arena::CreateMaybeMessage< ::proto2_arena_unittest::ImportNoArenaNestedMessage >(Arena* arena) {
