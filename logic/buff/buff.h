...
class buff : public iBuff, public api::iTimer {
public:
    virtual ~buff() {}
    ...
    virtual void createBuff(iUnit * scene, const s32 configid, const s64 target);
    virtual void createBuff(iUnit * scene, const s32 configid, const std::set<s64> & targets);
    virtual void removeBuffFromRole(iUnit * scene, iUnit * role, iUnit * buff);
    virtual void recoverBuff(iUnit * buff);
